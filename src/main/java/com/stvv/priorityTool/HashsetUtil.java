...
public class HashsetUtil {
    ...
    public static void printLines() {
        ...
        while (iterator.hasNext()) {
            ...
            if (!className.equalsIgnoreCase("org.joda.time.chrono.gj.MainTest"))
        ...
        while (addIterator.hasNext()) {
            ...
            if (!curr.getClassName().equalsIgnoreCase("org.joda.time.chrono.gj.MainTest"))
                line.append("suite.addTest(" + curr.getClassName() + ".suite());" + "\n");
        }

        writeToFile(line.toString(), "AdditionalTestAllPackages");
    }
